...
export default function ScanQr() {
  ...
  async function startCamera() {
    ...
    try {
      ...
      await instance.start({ facingMode: "environment" }, { fps: 10, qrbox: { width: 240, height: 240 } }, (text) => lookup(text), () => {});
  ...
  return <div className="qr-page scan-page">
    ...
    <section className="scanner-card">
      ...
      <div className="scanner-actions">
        {!cameraActive ? <button type="button" onClick={startCamera} disabled={busy}>Use Phone Camera</button>
